    ...
    <footer className="border-t border-zinc-200 dark:border-zinc-900 py-12 px-6 bg-white dark:bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-sm font-light mb-4 text-zinc-900 dark:text-white">{t('footer.company.title')}</h3>
          ...
          <div>
            <h3 className="text-sm font-light mb-4 text-zinc-900 dark:text-white">{t('footer.contact.title')}</h3>
          ...
          <div>
            <h3 className="text-sm font-light mb-4 text-zinc-900 dark:text-white">{t('footer.legal.title')}</h3>
            <div className="space-y-2 text-xs text-zinc-500 dark:text-zinc-600">
