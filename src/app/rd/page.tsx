    ...
    pl: {
        ...
        cards: [
            ...
            },
            {
                ...
                title: 'Silnik geometryczny oparty na Signed Distance Fields',
                desc: 'Każdy istniejący system CAD/CAM w stomatologii reprezentuje anatomię jako siatkę wielokątów. My budujemy inaczej — wolumetryczna reprezentacja pola, algebraicznie czyste operacje, deterministyczny output. Fundamentalna zmiana warstwy geometrycznej.',
                cta: 'Manifesto →',
                href: '/dental-cad',
    ...
    en: {
        ...
        cards: [
            ...
            },
            {
                number: '02',
                label: 'DentalCAD Engine',
                title: 'Geometric engine based on Signed Distance Fields',
                desc: 'Every existing CAD/CAM system in dentistry represents anatomy as a polygon mesh. We\'re building differently — volumetric field representation, algebraically clean operations, deterministic output. A fundamental replacement of the geometric layer.',
                cta: 'Manifesto →',
                href: '/dental-cad',
                accent: 'from-blue-500/10 to-cyan-500/10',
                dot: 'bg-blue-500',
